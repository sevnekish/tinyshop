...
<html lang="en">
  ...
  <body>
    ...
    <script src="/scripts/navbar_tab_activator.js"></script>
    <!-- Add's 'action' class to active admin_bar tab -->
    <script src="/scripts/admin_bar_tab_activator.js"></script>
    <!-- Upload file script -->
    <script src="/scripts/file_input.js"></script>
    <!-- Makes all items in catalog equal height-->
    <script src="/scripts/catalog_div_height.js"></script>
    ...
    <script src="/scripts/admin_orders_activator.js"></script>
    <!--  Star plugin-->
